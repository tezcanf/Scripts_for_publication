...
for i in TRF_nos: 
    ...
    with open(os.path.join(result_folder,'Y_'+TRF_names[i]+'_2_voxel_smoothed_2022_equal_signal_freq_part2_4_stories.pickle'), 'wb') as f:
        pickle.dump(Y, f)
    ...
    for  (ANOVA_test, ANOVA_test_name) in zip(ANOVA_tests,ANOVA_test_names):
        ...
        with open(os.path.join(result_folder,'clu_'+TRF_names[i]+'_'+ANOVA_test_name+'_2_voxel_smoothed_2022_equal_signal_freq_part2_4_stories.pickle'), 'wb') as f:
            pickle.dump(clu, f)
