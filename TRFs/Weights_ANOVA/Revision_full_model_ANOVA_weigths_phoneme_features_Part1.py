...
with open(os.path.join(result_folder,'Y_all_phonemes_2_voxel_smoothed_equal_signal_part1_full_model_low_vs_high.pickle'), 'wb') as f:
    pickle.dump(Y, f)   
...
for  (ANOVA_test, ANOVA_test_name) in zip(ANOVA_tests,ANOVA_test_names):
    ...
    with open(os.path.join(result_folder,'clu_all_phonemes_'+ANOVA_test_name+'_2_voxel_smoothed_equal_signal_part1_full_model_low_vs_high.pickle'), 'wb') as f:
        pickle.dump(clu, f)
