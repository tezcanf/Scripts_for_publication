...
ANOVA_results_path = '/project/3027007.02/Scripts_for_publication/TRFs/Weights_ANOVA/Dutch_part1/'
...
entropy = np.load(os.path.join(ANOVA_results_path,'all_phonemes_LH_entropy_source.npy'), allow_pickle=True)    
langauge = np.load(os.path.join(ANOVA_results_path,'all_phonemes_LH_language_source.npy'), allow_pickle=True)     
interaction = np.load(os.path.join(ANOVA_results_path,'all_phonemes_LH_interaction_source.npy'), allow_pickle=True)  
...
utils.line_graph1((Data_French_low["phonemes"].square().sqrt().smooth('source', window_size=0.014, window='gaussian').mean(
    ...
    'source'))/3,['French Low ', 'French High ','Dutch Low ','Dutch High '], 'TRF Phoneme Features LH', entropy, langauge,interaction)  
        
        
entropy = np.load(os.path.join(ANOVA_results_path,'acoustic_edge_LH_entropy_source.npy'), allow_pickle=True)    
langauge = np.load(os.path.join(ANOVA_results_path,'acoustic_edge_LH_language_source.npy'), allow_pickle=True)     
interaction = np.load(os.path.join(ANOVA_results_path,'acoustic_edge_LH_interaction_source.npy'), allow_pickle=True)           
utils.line_graph1(Data_French_low["gammatone_on"].square().sqrt().smooth('source', window_size=0.014, window='gaussian').mean('frequency').mean(
    ...
    'source'),['French Low ', 'French High ','Dutch Low ','Dutch High '], 'TRF Acoustic Edges LH', entropy, langauge,interaction)                             
...
utils.line_graph1(Data_French_low["phonemes"].square().sqrt().smooth('source', window_size=0.014, window='gaussian').mean(
    ...
    'source'),['French Low ', 'French High ','Dutch Low ','Dutch High '], 'TRF Phoneme Onset LH', entropy, langauge,interaction)                             
...
utils.line_graph2(Data_French_low["cohort_surprisal"].square().sqrt().smooth('source', window_size=0.014, window='gaussian').mean(
    ...
    'source'),Data_Dutch_low["cohort_surprisal"].square().sqrt().smooth('source', window_size=0.014, window='gaussian').mean(
    'source'),Data_Dutch_high["cohort_surprisal"].square().sqrt().smooth('source', window_size=0.014, window='gaussian').mean(
    'source'),['French Low ', 'French High ','Dutch Low ','Dutch High '], 'TRF Cohort Surprisal LH', entropy, langauge,interaction)                          
...
utils.line_graph2(Data_French_low["cohort_entropy"].square().sqrt().smooth('source', window_size=0.014, window='gaussian').mean(
    ...
    'source'),Data_Dutch_low["cohort_entropy"].square().sqrt().smooth('source', window_size=0.014, window='gaussian').mean(
    'source'),Data_Dutch_high["cohort_entropy"].square().sqrt().smooth('source', window_size=0.014, window='gaussian').mean(
    'source'),['French Low ', 'French High ','Dutch Low ','Dutch High '], 'TRF Cohort Entropy LH', entropy, langauge,interaction)     
