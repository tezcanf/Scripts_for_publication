...
This script caluclates the explain variance of phoneme features by subtstracting the acoustic+freq model from the full model for both low and high entropy word models. 
...
models_low = ['equal_signal_phonemes+surprisal+entropy_low',
          'equal_signal_acoustic+phonemes+surprisal+entropy_low',]
          
models_high = ['equal_signal_phonemes+surprisal+entropy_high',
...
df.to_csv(os.path.join(Results_path,'Accuracies_both_hemispheres_word_entropy_French_Dutch_part1_phoneme_diff.csv'))
